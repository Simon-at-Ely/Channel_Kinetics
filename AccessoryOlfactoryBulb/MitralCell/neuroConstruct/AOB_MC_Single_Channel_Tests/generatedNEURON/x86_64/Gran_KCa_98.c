...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 5);
 	...
 	ivoc_help("help ?1 Gran_KCa_98 /home/Simon/Channel_Kinetics/AccessoryOlfactoryBulb/MitralCell/neuroConstruct/AOB_MC_Single_Channel_Tests/generatedNEURON/x86_64/Gran_KCa_98.mod\n");
...
static int  settables ( _threadargsprotocomma_ double _lv , double _lcai ) {
   double _lalpha , _lbeta , _ltau , _linf , _lgamma , _lzeta , _lca_conc , _ltemp_adj_m ;
