...
extern Memb_func* memb_func;
 ...
 "setdata_NaP_iAMC_ChannelML", _hoc_setdata,
 "rates_NaP_iAMC_ChannelML", _hoc_rates,
 0, 0
};
...
#define usetable usetable_NaP_iAMC_ChannelML
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_NaP_iAMC_ChannelML", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "gmax_NaP_iAMC_ChannelML", "S/cm2",
...
"NaP_iAMC_ChannelML",
 ...
 0,
 "gion_NaP_iAMC_ChannelML",
 "minf_NaP_iAMC_ChannelML",
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 NaP_iAMC_ChannelML /home/Simon/Channel_Kinetics/AccessoryOlfactoryBulb/MitralCell/neuroConstruct/AOB_MC_Single_Channel_Tests/generatedNEURON/x86_64/NaP_iAMC_ChannelML.mod\n");
