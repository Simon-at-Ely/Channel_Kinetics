...
// XSL file with mapping to simulator: /home/Simon/Channel_Kinetics/AccessoryOlfactoryBulb/MitralCell/neuroConstruct/AOB_MC_Single_Channel_Tests/cellMechanisms/KA_iAMC_ChannelML/ChannelML_v1.8.1_NEURONmod.xsl
